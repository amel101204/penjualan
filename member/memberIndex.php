        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Tombol Delete -->
                            <a href="memberController.php" class="btn btn-danger btn-sm" onclick="return confirmAction('delete')">Delete</a>
                            <!-- Tombol Edit -->
                            <a href="memberView.php" class="btn btn-primary btn-sm">Edit</a>
                        </td>
