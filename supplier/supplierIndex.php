...
<div class="sidebar">
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link sidebar-item" href="../dashboard.php?roleCode=">Dashboard</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link sidebar-item" href="supplierIndex.php">Supplier</a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link sidebar-item" href="../memberIndex.php">Member</a>
        </li>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Tombol Delete -->
                            <a href="supplierController.php" class="btn btn-danger btn-sm" onclick="return confirmAction('delete')">Delete</a>
                            <!-- Tombol Edit -->
                            <a href="supplierView.php" class="btn btn-primary btn-sm">Edit</a>
                        </td>
